...
<div class="main-view" style=" margin-right: 50px;">
    ...
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Update'), ['виправити', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
...
<?php
  ...
  if(\Yii::$app->user->can('contractor') && $model->status_objekt==5 && $model->price_pidr_end !=0){ 
  ...
  if(\Yii::$app->user->can('contractor') && $model->status_objekt==5 && $model->price_pidr_end ==0  && $model->status_pidr==4){
